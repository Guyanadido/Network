    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2023, 12, 15, 11, 11, 1, 808948))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followingUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='follows', to=settings.AUTH_USER_MODEL)),
            ],
            options={
